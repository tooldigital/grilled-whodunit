...
module.exports = {
	...
	hints: (variation, suspect) => {
		//TODO reimplement suspect hints?
		// if(suspectKey) combinedhints = combinedhints.concat(suspectsResponses[suspectKey].hints)
	...
	presscharges: {
		...
		whatevidence: `What proof do you have? Is their alibi? Or if it's a piece of evidence, name the specific thing.`,

...
module.exports = {
	common: [
		{key: 'PROMPT_RELATIONS', 			text: suggest() + 'Try asking if they know one of the other suspects.<break time=".5s" /> After all Lockhart is a small town.'},
		...
		[
			{
				...
				text: 'I have a hunch. Ask Tucker where he was on the night of the murder.'
			}
		],
